...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $contactblockheader->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("ContactBlockHeaders", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/contactblockheaders/'.$contactblockheader->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("ContactBlockHeaders", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.contactblockheaders.destroy', $contactblockheader->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/contactblockheaders') }}" data-toggle="tooltip" data-placement="right" title="Back to ContactBlockHeaders"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'small_heading')
						@la_display($module, 'big_heading')
