	...
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $social_network->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Social_networks", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/social_networks/'.$social_network->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Social_networks", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.social_networks.destroy', $social_network->id], 'method' => 'delete', 'style'=>'display:inline']) }}
