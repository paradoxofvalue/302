...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $firstblocklist->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("FirstBlockLists", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/firstblocklists/'.$firstblocklist->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("FirstBlockLists", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.firstblocklists.destroy', $firstblocklist->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/firstblocklists') }}" data-toggle="tooltip" data-placement="right" title="Back to FirstBlockLists"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'fblName')
						@la_display($module, 'fblDescription')
					</div>
				</div>
			</div>
		</div>
