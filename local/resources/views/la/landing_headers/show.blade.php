...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $landing_header->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Landing_headers", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/landing_headers/'.$landing_header->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Landing_headers", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.landing_headers.destroy', $landing_header->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/landing_headers') }}" data-toggle="tooltip" data-placement="right" title="Back to Landing headers"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'big_text')
						@la_display($module, 'small_text')
					</div>
				</div>
			</div>
		</div>
