...
class CreateSeventhblocklistsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Seventhblocklists", 'seventhblocklists', 'name', 'fa-cube', [
    ...
    {
        if (Schema::hasTable('seventhblocklists')) {
            Schema::drop('seventhblocklists');
        }
    }
}
