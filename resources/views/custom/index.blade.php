    ...
    <div class="container">
        ...
        <div class="row">
            <ul class="client-slider clearfix" id="clint-slider">
                <li><img src="custom-assets/img/clients/logo1.png" alt="" class="grayscale"></li>
                <li><img src="custom-assets/img/clients/logo2.png" alt="" class="grayscale"></li>
                <li><img src="custom-assets/img/clients/logo3.png" alt="" class="grayscale"></li>
                <li><img src="custom-assets/img/clients/logo4.png" alt="" class="grayscale"></li>
                <li><img src="custom-assets/img/clients/logo5.png" alt="" class="grayscale"></li>
                <li><img src="custom-assets/img/clients/logo6.png" alt="" class="grayscale"></li>
                <li><img src="custom-assets/img/clients/logo7.png" alt="" class="grayscale"></li>
                <li><img src="custom-assets/img/clients/logo1.png" alt="" class="grayscale"></li>
                <li><img src="custom-assets/img/clients/logo2.png" alt="" class="grayscale"></li>
            </ul>
        </div>
...
>>>>>>> 6ffe5524f09dda71a34214bc5af3263e31cec3e2
